...
**MNIST Dataset** — a benchmark dataset containing **60,000 training** and **10,000 testing** grayscale images of handwritten digits (0–9), each sized **28×28 pixels**.
...
**Muhammad Moosa**
GitHub: [moosabhat7893](https://github.com/moosabhat7893)
